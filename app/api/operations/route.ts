...
export async function GET(request:Request){try{return Response.json(await operationsData(await actor(request)),{headers:{'Cache-Control':'no-store'}})}catch(e){return apiError(e)}}
