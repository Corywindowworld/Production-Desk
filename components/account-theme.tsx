...
export function AccountTheme({children}:{children:React.ReactNode}){
 ...
 return <ThemeContext.Provider value={{theme,loading,apply}}>{theme==='gators'&&<div className="gators-theme-banner"><img src="/gators-theme-mark.svg" alt="Gator theme logo" width="36" height="28"/><span>FLORIDA GATORS</span></div>}{children}</ThemeContext.Provider>
}
