...
type CalendarJob = {installPeriod?:string|null;stopNumber?:number|null;id:string;number:string;customer:string;install:string;crew:string;stage:string};
