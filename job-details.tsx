...
export function JobDetails({job}:{job:JobDetailsData}){
 return <div className="job-readonly">{job.id&&<a className="app-link" href={'/customers?job='+encodeURIComponent(job.id)}>Open customer & project record →</a>}
